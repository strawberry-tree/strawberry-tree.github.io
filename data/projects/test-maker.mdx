...
<div className="grid grid-cols-1 lg:grid-cols-12 gap-2">
  ...
  <img
    ...
    className="w-full h-auto object-cover lg:col-span-6"
  />
...
<img className="mx-auto block w-full max-w-md" src="/static/images/test-maker/test-maker-2.png" />
...
<img className="mx-auto block w-full max-w-md" src="/static/images/test-maker/test-maker-3.png" />

**해결**: **현재 진행 단계**, **문제 데이터**, **사용자가 제출한 정답 데이터**를 **세션 상태에 캐싱**하였습니다. 3단계 흐름이 진행되는 동안 **세션에 캐싱된 데이터를 재사용**하여 불필요한 API 재호출을 방지했습니다.
