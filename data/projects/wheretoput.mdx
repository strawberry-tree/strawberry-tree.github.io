...
<img
  className="mx-auto hidden max-w-lg print:block"
  src="/static/images/wheretoput/wheretoput-7.png"
></img>
<img
  className="mx-auto w-full max-w-2xl print:max-w-lg"
...
<img className="mx-auto w-full print:max-w-lg" src="/static/images/wheretoput/wheretoput-1.png" />
...
<img
  className="mx-auto w-full max-w-3xl print:w-lg"
  src="/static/images/wheretoput/wheretoput-2.png"
/>
